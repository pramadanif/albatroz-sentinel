      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            ...
            <a href="https://github.com/pramadanif/albatroz-sentinel/blob/main/README.md" target="_blank" className="group px-8 py-4 border border-[#333333] text-gray-400 font-bold tracking-widest uppercase hover:text-[#00FFFF] hover:border-[#00FFFF] transition-all">
              <span className="flex items-center gap-2">
                [ READ_DOCS ]
